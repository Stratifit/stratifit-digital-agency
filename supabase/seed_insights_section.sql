-- ============================================================================
-- Stratifit — Insights Section Seed Data
-- Inserts one Insights section with 4 insight cards.
-- Run this after the insights_section migration has been applied.
-- ============================================================================

-- Fixed section ID so this seed file is idempotent
DO $$
DECLARE
  v_section_id uuid := 'f1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d'::uuid;
BEGIN
  -- Insert / update the Insights section
  ...
  VALUES (
    v_section_id,
    4,
    '{"en":"Knowledge","fr":"Connaissances","de":"Wissen","es":"Conocimiento"}'::jsonb,
    '{"en":"Insights & Expertise","fr":"Perspectives & Expertise","de":"Einblicke & Expertise","es":"Perspectivas y Experiencia"}'::jsonb,
    '{"en":"Thought leadership and industry perspectives from our team of strategists and engineers.","fr":"Réflexions et perspectives sectorielles de notre équipe de stratèges et d\'ingénieurs.","de":"Thought-Leadership und Branchenperspektiven von unserem Team aus Strategen und Ingenieuren.","es":"Liderazgo intelectual y perspectivas sectoriales de nuestro equipo de estrategas e ingenieros."}'::jsonb,
    '/insights',
    '{"en":"View All Insights","fr":"Voir Tous les Articles","de":"Alle Einblicke Anzeigen","es":"Ver Todas las Perspectivas"}'::jsonb,
    '{"en":"Read Insight","fr":"Lire l\'Article","de":"Einblick Lesen","es":"Leer Perspectiva"}'::jsonb
  )
  ...
  -- Delete existing cards for this section to avoid duplicates on re-runs
  DELETE FROM insight_cards WHERE parent_section = v_section_id;
  ...
  VALUES
    (
      'f2b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6e'::uuid,
      v_section_id,
    ...
    (
      'f3b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6e'::uuid,
      v_section_id,
    ...
    (
      'f4b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6e'::uuid,
      v_section_id,
    ...
    (
      'f5b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6e'::uuid,
      v_section_id,
