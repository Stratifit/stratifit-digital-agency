        ...
        <Container className="relative z-10">
          <div className="grid items-center gap-8 md:gap-16">
            <div className="space-y-4 md:space-y-8 lg:mx-auto lg:max-w-4xl lg:text-center">
              <Reveal>
                <h1 className="flex flex-col items-center justify-center font-display text-[clamp(1rem,5.5vw,3.5rem)] font-black leading-[1.15] tracking-tight text-text-primary">
