...
export function AdminShell({
  ...
  return (
    <div className="relative flex min-h-screen bg-background">
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex h-full w-64 flex-col border-r border-border bg-background-deep shadow-xl shadow-black/40 transition-[width,transform] duration-300 ease-[var(--ease-standard)] md:sticky md:top-0 md:z-auto md:h-screen md:shadow-none",
