          ...
          <div key={group.id} className="flex min-w-0 flex-col gap-2.5">
            ...
            {group.links.map((link) => (
              <a
                ...
                onClick={onLinkClick}
                className="text-[10px] text-text-subtle transition-colors duration-[var(--motion-fast)] ease-[var(--ease-standard)] hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary break-words sm:text-sm"
              >
