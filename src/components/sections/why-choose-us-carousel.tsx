  ...
  return (
    <div className="lg:hidden">
      <div
        ...
        className="-mx-6 flex touch-pan-x touch-pan-y snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:-mx-8 lg:px-8"
      >
