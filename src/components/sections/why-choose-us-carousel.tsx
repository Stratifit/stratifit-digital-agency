...
function WhyCard({
  ...
  return (
    <div className="relative flex w-[300px] shrink-0 snap-center flex-col overflow-hidden rounded-card border border-white/5 bg-card-dark p-6 shadow-xl shadow-black/50">
  ...
  return (
    <div className="lg:hidden">
      <div
        ...
        className="-mx-6 flex touch-pan-x touch-pan-y overscroll-x-contain snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:-mx-8 lg:px-8"
      >
