        ...
        >
          {filtered.map((project) => (
            <article
              key={project.slug}
              data-project-card
              className="group w-[300px] shrink-0 snap-center overflow-hidden rounded-radius-card-lg border border-card-border bg-card-dark transition-all duration-[var(--motion-medium)] ease-[var(--ease-standard)] hover:border-primary/20 sm:w-[340px] md:w-[380px]"
            >
