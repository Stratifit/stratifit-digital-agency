    ...
    <div>
      ...
      <div className="relative">
        <div
          ...
          className="-mx-4 flex snap-x snap-mandatory gap-6 overflow-x-auto px-4 pb-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:-mx-6 sm:px-6"
        >
          {filtered.map((project) => (
            <article
              key={project.slug}
              data-project-card
              className="group w-[300px] shrink-0 snap-center overflow-hidden rounded-2xl border border-card-border bg-card-dark transition-all duration-[var(--motion-medium)] ease-[var(--ease-standard)] hover:border-primary/20 sm:w-[340px] md:w-[380px]"
            >
