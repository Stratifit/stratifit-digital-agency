...
function StepCard({
  ...
  return (
    <div className="relative flex w-[80vw] min-w-[280px] max-w-[320px] shrink-0 snap-center flex-col overflow-hidden rounded-card border border-card-border bg-card-dark p-6">
  ...
  return (
    <div className="mt-12 md:hidden">
      <div
        ...
        className="-mx-6 flex touch-pan-x touch-pan-y overscroll-x-contain snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:-mx-8 lg:px-8"
      >
        {steps.map((step) => (
