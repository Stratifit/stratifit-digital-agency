...
function StepCard({
  ...
  return (
    <div className="relative flex w-[80vw] min-w-[280px] max-w-[320px] shrink-0 snap-center flex-col overflow-hidden rounded-radius-card border border-card-border bg-card-dark p-6">
