...
export function InsightCard({
  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-radius-card border border-card-border bg-card-dark transition-all duration-[var(--motion-medium)] ease-[var(--ease-standard)] hover:border-primary/20">
