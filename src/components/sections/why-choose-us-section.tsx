      ...
      <Container>
        ...
        <div className="mt-12 hidden gap-6 lg:grid lg:grid-cols-4">
          {items.map((item, index) => (
            <div
              key={index}
              className="group relative flex flex-col overflow-hidden rounded-radius-card-lg border border-white/5 bg-card-dark p-6 shadow-xl shadow-black/50 transition-all duration-500 hover:-translate-y-0.5 hover:border-primary/20 md:p-8"
            >
