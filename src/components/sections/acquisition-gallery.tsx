...
function BusinessCard({ business }: { business: AcquisitionBusiness }) {
  return (
    <article className="group flex w-[300px] shrink-0 snap-center flex-col overflow-hidden rounded-card border border-card-border bg-card-dark transition-all duration-300 hover:border-primary/20 sm:w-[340px] md:w-[380px]">
