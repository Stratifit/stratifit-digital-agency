        ...
        >
          {testimonials.map((testimonial, index) => (
            <article
              ...
              className="min-w-[300px] w-[300px] shrink-0 snap-center rounded-radius-card-lg border border-card-border bg-card-dark p-6 transition-all duration-[var(--motion-fast)] ease-[var(--ease-standard)] hover:border-primary/20 md:p-8 sm:w-[360px] md:w-[400px]"
            >
