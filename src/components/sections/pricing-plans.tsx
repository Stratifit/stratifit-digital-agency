...
function PlanCard({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col rounded-radius-card-lg border bg-card-dark p-6 transition-all duration-[var(--motion-medium)] ease-[var(--ease-standard)] md:p-8",
        mobile
    ...
    <div>
      ...
      <div className="md:hidden">
        <div
          ...
          className="-mx-6 flex snap-x snap-mandatory gap-4 overflow-x-auto px-6 pt-5 pb-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:-mx-8 lg:px-8"
        >
          {plans.map((plan) => (
