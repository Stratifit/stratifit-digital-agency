...
export function AttachIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function HeartIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function DoubleChatBubbleIcon({
  className = "w-5 h-5",
  ...props
}: IconProps) {
  return (
...
export function BrandIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function WebDevIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function SeoIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function BrushIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function AtomIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function DiscoveryIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function StrategyIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function BuildIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function LaunchIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export const SERVICE_ICON_IDS = Object.keys(
  SERVICE_ICONS
) as unknown as readonly [
...
export const SERVICE_ICON_LABELS: Record<ServiceIconId, string> = {
  brand: "Brand",
  web: "Web Development",
  marketing: "Marketing",
  seo: "SEO",
...
export const HOW_WE_WORK_ICON_IDS = Object.keys(
  HOW_WE_WORK_ICONS
) as unknown as readonly [
  keyof typeof HOW_WE_WORK_ICONS,
  ...(keyof typeof HOW_WE_WORK_ICONS)[]
];

export type HowWeWorkIconId = (typeof HOW_WE_WORK_ICON_IDS)[number];

export const HOW_WE_WORK_ICON_LABELS: Record<HowWeWorkIconId, string> = {
  discovery: "Discovery",
  strategy: "Strategy",
  build: "Build",
  launch: "Launch",
...
export const WHY_US_ICON_IDS = Object.keys(
  WHY_US_ICONS
) as unknown as readonly [
  keyof typeof WHY_US_ICONS,
  ...(keyof typeof WHY_US_ICONS)[]
];

export type WhyUsIconId = (typeof WHY_US_ICON_IDS)[number];

export const WHY_US_ICON_LABELS: Record<WhyUsIconId, string> = {
  shield: "Shield",
};
