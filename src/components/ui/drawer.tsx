  ...
  <DialogPrimitive.Portal>
    ...
    >
      ...
      <DialogPrimitive.Close
        ...
        className="absolute right-4 top-4 z-30 rounded-radius-xs p-1 text-text-muted transition-colors duration-[var(--motion-fast)] ease-[var(--ease-standard)] hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      >
