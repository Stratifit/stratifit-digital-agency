...
export interface PublicHero {
  ...
  /** Toggles whether the trusted-by logo strip shows. Defaults to true when absent (pre-migration). */
...
const SELECT_FIELDS =
  "media_id, eyebrow_translations, title_translations, highlight_translations, description_translations, primary_cta_label_translations, primary_cta_url, secondary_cta_label_translations, secondary_cta_url, metrics, trusted_by, trusted_by_enabled, trusted_by_label_translations";
